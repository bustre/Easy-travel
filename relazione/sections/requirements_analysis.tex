...
%
Ogni \textbf{transizione} viene identificata da un \underline{codice} e riporta i seguenti dati: la banca dove è avvenuto il pagamento, il circuito bancario usato e il timestamp della transizione.
%
% Pacchetti
%
...
\end{itemize}
\end{multicols}
Ogni viaggio deve fare riferimento ad una \textbf{polizza} assicurativa che viene identificata nel sistema attraverso un \underline{ID}, inoltre viene salvata: una descrizione della polizza e il nome dell'agenzia di assicurazione.
%
% Trasporto & tratte
%
