...
\begin{multicols}{2}
    \begin{itemize}
     ...
     \end{itemize}
 \end{multicols}
 Un utente non può ricevere punti se fa uso dello sconto.
%
% Pacchetti
%
